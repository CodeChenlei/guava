...
public class ListsTest extends TestCase {
	...
	public static Test suite() {
		...
		suite.addTest(ListTestSuiteBuilder.using(new TestStringListGenerator() {
			...
			protected List<String> create(String[] elements) {
				...
				.withFeatures(CollectionSize.ANY, ListFeature.REMOVE_OPERATIONS, CollectionFeature.SERIALIZABLE,
	...
	public void testCartesianProduct_2x2x2() {
		assertThat(Lists.cartesianProduct(list(0, 1), list(0, 1), list(0, 1)))
				.containsExactly(list(0, 0, 0), list(0, 0, 1), list(0, 1, 0), list(0, 1, 1), list(1, 0, 0),
